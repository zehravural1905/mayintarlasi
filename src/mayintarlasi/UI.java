...
public class UI extends JFrame
{
    ...
    // Frame settings
    private final String FRAME_TITLE = "Mayın Tarlası";
    ...
    {                
        ...
        newGame = new JMenuItem("   Yeni Oyun");
        statistics = new JMenuItem("   İstatistikler");
        exit = new JMenuItem("   Çıkış");
    ...
    public void setButtonListeners(Oyun game)
    {
